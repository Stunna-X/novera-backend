"""
Seed workforce permissions.

Adds workforce permissions and assigns them to existing
system roles without modifying earlier permissions.
"""
...
PERMISSIONS = {
    ...
    "workforce.read": (
        "View organization workforce profiles."
    ),
    "workforce.update": (
        "Update workforce profiles."
    ),
    "workforce.delete": (
        "Deactivate workforce profiles."
    ),
}
...
def seed_workforce_access() -> None:
    """
    Create missing workforce permissions and role assignments.
    """
    ...
    print(
        "Workforce access seeded successfully: "
